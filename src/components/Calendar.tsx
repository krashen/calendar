...
import { Event } from '../contexts/Events' 
    ...
    return (
        ...
        <OverflowContainer
            ...
            renderOverflow={amount => (          
                <>
                    <button onClick={() => setIsViewMoreEventsModalOpen(true)}>+{amount} More</button>  
                    <ViewMoreCalendarEventModal 
                        events={sortedEvents}
...
type ViewMoreCalenderEventsModalProps = {
    events: Event[]
} & Omit<ModalProps, "children">

function ViewMoreCalendarEventModal({events, ...modalProps}: ViewMoreCalenderEventsModalProps) {
    return (
        <Modal {...modalProps}>
        ...
        <button 
            ...
            {event.allDay ? (
                ...
                <Fragment>
                    ...
                    <div className="event-time">{formatDate(parse(event.startTime!, "HH:mm", event.date), {timestyle: "short"})}</div>
                    <div className="event-name">{event.name}</div>
                </Fragment>
            )}
        </button>
        ...
        <div className="modal-title">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group checkbox">
              <input checked={isAllDayChecked} onChange={(e) => setIsAllDayChecked(e.target.checked)} type="checkbox" id={`${formId}-all-day`} />
            ...
            <div className="row">
              <button className="btn btn-success" type="submit">{isNew ? "Add" : "Update"}</button>
              {onDelete != null && 
                <button
